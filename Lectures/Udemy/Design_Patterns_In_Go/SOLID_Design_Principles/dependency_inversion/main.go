...
// Both should depend on abstractions (abstraction means interface in Go typically)
...
// HLM
// use interface instead of using low level module struct directly for abstraction
...
func (r *Research) Investigate() {
	...
	// use abstraction to loosely coupled with low-level module
