...
type FormattedText struct {
	plainText  string
	capitalize []bool // problem: huge boolean arrays consume a lot of memory
}
...
// TextRange is a flyweight pattern
// solution: use a flyweight pattern to store the formatting information to save memory
