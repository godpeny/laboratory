...
func main() {
	//multiple_aggregation := Dragon{}
	//multiple_aggregation.Bird.Age = 10
	//fmt.Println(multiple_aggregation.Lizard.Age)
	//multiple_aggregation.Fly()
	//multiple_aggregation.Crawl()
